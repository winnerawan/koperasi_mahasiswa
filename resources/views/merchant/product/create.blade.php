                                ...
                                <div class="col-12">
                                    <div class="p-20">
                                        ...
                                        <div class="panel-body">
                                            {!! Form::open(['route' => 'merchant.product.store', 'data-parsley-validate' => '', 'class' => 'form-horizontal', 'files' => true, 'method' => 'POST  ']) !!}
                                            ...
                                            <!-- <div class="form-group">
                                                ...
                                                <div col-sm-10style="margin-left: 20px;" class="input-group col-sm-10">
                                                    <span class="input-group-addon">Rp.</span>
                                                    {{ Form::text('price', null, array('class' => 'hargajual form-control', 'required' => '', 'maxlength' => '255')) }}
                                                    <span class="input-group-addon">.00</span>
                                                </div>
                                            </div> -->
                                            <div class="form-group">

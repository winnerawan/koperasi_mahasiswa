                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-7 col-xs-12">
                                    <div class="single-product-info">
                                        ...
                                        <h3 class="pro-price">Harga: Rp. {{ $product->price + ($product->price * $tax->tax/100) }}</h3>
                                        <input type="hidden" id="pro_price" name="pro_price" value="{{ $product->price + ($product->price * $tax->tax/100) }}">
                                        <input type="hidden" id="untung" name="untung" value="{{ $product->price * ($tax->tax/100) }}">
                                        <!-- hr -->
                                        <hr>
